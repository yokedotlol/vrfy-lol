...
<p style="margin-top:0.75rem;padding:8px 12px;background:#111116;border-left:3px solid #38d9a9;border-radius:4px;font-size:12px;color:#8e8e9a">🔒 <strong style="color:#38d9a9">Privacy:</strong> Email addresses are sent via POST to vrfy.lol — never in URLs, never logged. Raw email addresses never stored — extended cache HMAC 30d. No accounts, no tracking. Proof-of-work replaces API keys. You can always self-host if you need privacy. <a href="https://github.com/yokedotlol/vrfy-lol" style="color:#9b8afb">Source is on GitHub.</a></p>
